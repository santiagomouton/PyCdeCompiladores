...
public class startParser extends Parser {
	...
	public static class SContext extends ParserRuleContext {
		...
		public Token NUMERO;
		public Token OTRO;
		public TerminalNode ID() { return getToken(startParser.ID, 0); }
		public SContext s() {
			return getRuleContext(SContext.class,0);
		}
		public TerminalNode NUMERO() { return getToken(startParser.NUMERO, 0); }
		public TerminalNode OTRO() { return getToken(startParser.OTRO, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof startListener ) ((startListener)listener).enterS(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof startListener ) ((startListener)listener).exitS(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof startVisitor ) return ((startVisitor<? extends T>)visitor).visitS(this);
	...
	public static final String _serializedATN =
		...
		"\2\t\17\5\2\2\2\n\13\7\5\2\2\13\f\b\2\1\2\f\17\5\2\2\2\r\17\7\2\2\3\16"+
